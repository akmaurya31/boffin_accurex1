        ...
        <div class="row">
            ...
            <div class="col-md-4 col-12 loginForm">
                <div class="card p-4">
                    ...
                    <form id="loginForm" method="post" action="<?php echo base_url('Clients/verifyEnterOTP');?>">
                        ...
                        <div class="mb-3 mt-3 text-start">
                            <input type="hidden" name="auth_ID" value="<?php echo $this->session->userdata('auth_ID');?>">
