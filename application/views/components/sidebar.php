        ...
        <div id="sidebar-menu" class="sidebar-menu">
            ...
            <ul>
                <li class="menu-title">Main</li>
                    ...
                    <?php if($this->user_lib->is_has_access('2') && $this->session->userdata('user_ID') === "1"){?>
                    ...
                    <li class="<?php echo ($page == 'Users' || $page == 'Users/Create') ? 'active' : '';?> submenu">
							...
							<ul style="display: none;">
								<li><a href="<?php echo base_url('list-user');?>">Employee List</a></li>
								<li><a href="<?php echo base_url('create-user');?>">Create Employee</a></li>
							</ul>
						</li>
                    <?php }?>
                    
                    <?php if($this->user_lib->is_has_access('4')){?>
                        <li class="<?php echo ($page == 'Client' || $page == 'Client/Create') ? 'active' : '';?> submenu">
							<a href="<?php echo base_url('create-client');?>">
                                <i class="fa fa-user-o"></i>
                                <span>Manage Clients</span>
                            </a>

							<ul style="display: none;">
								<li><a href="<?php echo base_url('list-client');?>">Client List</a></li>
								<li><a href="<?php echo base_url('create-client');?>">Create Client</a></li>
							</ul>
						</li>
                    <?php }?>

                    <?php if($this->user_lib->is_has_access('4')){?>
                        <li class="<?php echo ($page == 'IPList' || $page == 'IPList/Create') ? 'active' : '';?>">
                            <a href="<?php echo base_url('ip-list');?>">
                                <i class="fa fa-globe"></i>
                                <span>WhitList IP</span>
                            </a>
                        </li>
                    <?php }?>
