<div class="row">
    ...
    <div class="col-sm-8 col-9 text-right m-b-20">
        <a href="<?php echo base_url('create-client');?>" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Add Client</a>
    </div>
</div>
                        ...
                        <td class="text-right">
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="<?php echo base_url('edit-client/'.$user->user_ID);?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                    ...
                                    <a class="dropdown-item" href="<?php echo $user->status == 1 ? 'active-client/'.$user->user_ID : 'block-client/'.$user->user_ID;?>">
...
<?php foreach($users as $del){?>
        <form id="delete_employee_<?php echo $del->user_ID;?>" class="modal fade delete-modal" role="dialog" action="<?php echo base_url('delete-client');?>" method="POST">
